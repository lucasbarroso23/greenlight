...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	// defining request body max size
	maxBytes := 1_048_576
	...
	// important note, this second call to decode is used to check if there is more than one json element on the body
	// since its a stream of elements
